...
def new_post():
    if request.method == 'POST':
        ...
        if blog_body =='':
            ...
            return redirect("/newpost?bod_error=" + error+"&blog_title=" +blog_title)
    ...
    if not blog_title:
        blog_title=''
    return render_template('newpost.html',pgtitle='Build A Blog',tit_error=tit_error,bod_error=bod_error,blog_title=blog_title)
